        ...
        with open(file_path, mode='rU') as file_handler:
            for p in csv.reader(file_handler):
                ...
                try:
                    ...
                    # Create post
                    post = Post(original_id=p[0], name=p[2], slug=p[1], meta=p[6], summary=p[3], description=p[4],
                                is_music=True, catnum=p[8], length=p[10], quality=p[11], tracklist=p[12],
                                viewed=p[17], created=date)
