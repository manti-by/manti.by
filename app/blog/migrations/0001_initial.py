    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release', models.FileField(blank=True, max_length=255, null=True, upload_to=core.utils.release_name, verbose_name='Release File')),
                ('cover', models.ImageField(blank=True, max_length=255, null=True, upload_to=core.utils.cover_name, verbose_name='Cover Image')),
                ...
                ('related', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='blog.Post')),
