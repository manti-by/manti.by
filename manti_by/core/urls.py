...
from manti_by.core import views as core_views
from manti_by.api.resources import OrderableResource, PostResource, SearchResource
from manti_by.core.sitemap import IndexSitemap, BlogSitemap, StaticSitemap
...
urlpatterns = [
    ...
    # Blog urls
    path("blog/", include("manti_by.blog.urls"), name="blog"),
    path("gallery/", include("manti_by.gallery.urls")),
    path("profile/", include("manti_by.profiles.urls")),
    # URL shortener
    path("sr/", include("manti_by.shortener.urls")),
    # Admin urls
