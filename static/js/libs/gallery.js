(($) => {
  ...
  class Gallery {
    ...
    init () {
      const close_pointer = $('<div class="close"><i class="material-icons">close</i></div>')
      const next_pointer = $('<div class="next"><i class="material-icons">chevron_right</i></div>')
      const prev_pointer = $('<div class="prev"><i class="material-icons">chevron_left</i></div>')
      const overlay = $('<div id="overlay" class="hidden"></div>')
    ...
    resize () {
      const shift_x = ($(window).width() - this.image.width()) / 2
      const shift_y = ($(window).height() - this.image.height()) / 2
